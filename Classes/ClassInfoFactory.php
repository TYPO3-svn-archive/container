...
class Tx_Container_ClassInfoFactory {
	...
	public function buildClassInfoFromClassName($className) {
		...
		return new Tx_Container_ClassInfo( $className, $key, $cd, $is, $this->hasInjectExtensionSettingsMethod);
	}
	 ...
	 */
	private function getConstructorDependencies($reflectedClass) {
	 ...
	 * 
	 */
	private function getSetterDependencies($reflectedClass) {
